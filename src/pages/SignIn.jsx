    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img src="https://images.unsplash.com/photo-1585914641050-fa9883c4e21c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8a2V5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60" 
          ...
          <form>
            ...
            <div className='relative mb-6'>
              <input type={showPassword ? 'text': 'password'} id='password' value={password} 
                onChange={onChange} placeholder='Votre mot de passe' className='w-full px-4 
                py-2 text-xl text-gray-700 bg-white rounded transition ease-in-out'/>
              {showPassword ? (
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p>
                <Link to='/mot-de-passe-oublie' className='text-blue-500 hover:text-blue-700 transition duration-200 ease-in-out ml-1'>Mot de passe oublié ?</Link>
              </p>
            </div>
